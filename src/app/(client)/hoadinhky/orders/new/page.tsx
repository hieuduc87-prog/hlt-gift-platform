...
export default function NewOrderPage() {
  ...
  async function handleSubmit() {
    ...
    if (err || !newOrder) {
      ...
      router.push(`/hoadinhky/orders/${newOrder.id}`);
    }
  }
  ...
  return (
    <div className="max-w-2xl">
      <Link href="/hoadinhky/orders" className="inline-flex items-center gap-1 text-sm text-text-secondary hover:text-foreground mb-4">
        ...
        <div className="space-y-3">
          ...
          {recipients.length === 0 ? (
            <div className="text-center py-8">
              ...
              <Link href="/hoadinhky/recipients/new" className="text-gold hover:text-gold-dark font-medium text-sm">
                Thêm người nhận
              </Link>
            </div>
          ) : (
